...
classify(_:as:) routes through a CastEnum with both
...
Full source: [Examples/Sources/Classify/main.swift](https://github.com/jaylann/Cast/blob/main/Examples/Sources/Classify/main.swift)
